...
export default function ThemeToggleButton({
  ...
  return (
    <Button
      ...
      variant="ghost"
      size="icon"
      className={`w-9 p-0 h-9 relative group ${className}`}
      name="Theme Toggle Button"
    >
      <SunIcon className="size-[1.2rem] rotate-0 scale-100 transition-all " />
      <MoonIcon className="absolute size-[1.2rem] rotate-90 scale-0 transition-all " />
