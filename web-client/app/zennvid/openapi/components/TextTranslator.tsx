...
import { LANGUAGES, TEXT_TRANSLATE } from "@/constants/backend_routes";
...
const endpoints = [
  {
    ...
    sampleResponse: {
      "MESSAGE": "Translation succesfully",
      "SUCCESS": true,
      "ERROR": null,
      "DATA": {
        "translate": "हैलो आज आप कैसे हैं?"
      }
    }
  },
  {
    method: 'GET',
    endpoint: LANGUAGES,
    description: 'Get list of supported languages - here sample response is trimmed',
    credits: 0,
    sampleRequest: {},
    sampleResponse: {
      SUCCESS: true,
...
export default function TextTranslatorPage() {
  return (
    <ApiDocumentation
      ...
      description="Translate text between over 100 languages with enterprise-grade accuracy. Supports batch translation, language detection, and formatting preservation."
      endpoints={endpoints}
    />
  );
}
