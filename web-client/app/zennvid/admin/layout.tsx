      ...
      <ThemeProvider>
        <QueryClientProviderWrapper>
            <SidebarProvider >
              ...
              {children}
              <div className="fixed top-1/2 left-1/4 w-64 h-64 bg-purple-200/30  rounded-full blur-3xl -z-10" />
              <div className="fixed bottom-1/4 right-1/4 w-96 h-96 bg-pink-200/30  rounded-full blur-3xl -z-10" />
            </SidebarProvider>
        </QueryClientProviderWrapper>
      </ThemeProvider>
    </div>
